...
1 в дилемме заключенного добавть подозреваемого, который будет предавать с заданной вероятностью (в процентах)
2 добавить класс "колода карт", который должен содержать массив из карт
 2.1 добавить возможность перемешивания колоды
