...
### 25.10.24
 ...
 <span style="color:green"> 1. в дилемме заключенного добавть подозреваемого, который будет предавать с заданной вероятностью (в процентах)</span>
...
- 1 . написать реализацию лотереи:
  - должен быть класс, которые умеет делать 2 вещи:
    - a) продавать билеты
    - b) проводить лотерею и определять, кто из купивших билеты выиграл
(обратить внимание на класс com.order.Order)

- 2 . сделать красивый туСтринг для карт (символами)

- 3 . сделать собственный arrayList (как делали стринг)
    - 3.1 . делаем базовый набор методов - добавление, удаление, взятие по индексу, размер, проверка на пустоту
