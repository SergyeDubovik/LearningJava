...
---
### 04.09.24
- [ ] подумать и попытаться реализовать ввод ходов в человеческом формате (вместо 2е-4е - е2-е4)

- [ ] подумать о том, как избавиться от дублирования кода для белых и черных (ходы)
