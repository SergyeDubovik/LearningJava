...
отсортировать ключи (чтоб года печатались по порядку)
адаптировать метод countMaxValue под новый метод чтения из файла
написать библиотеку: некий класс, который будет следить за тем, кто взял какую книгу, 
